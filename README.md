...
**[School_Library]** School Library is a web app built with ruby that records what books are in the library and who borrows them (teachers, students). 
...
```sh
  cd my-folder
  git clone[(https://github.com/joyapisi/school_library.git)]
```
